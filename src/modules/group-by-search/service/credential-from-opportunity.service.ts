...
@Injectable()
export class CredentialFromOpportunityService {
    ...
    async credentialFromOpportunity(body: any): Promise<any> {

        let real = await this.stemModal.find({ Opportunity: body.data }).then((res: any) => { return res })
